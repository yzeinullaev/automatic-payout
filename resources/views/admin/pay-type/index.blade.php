...
@section('title', trans('admin.pay-type.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.pay-type.actions.index') }}
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/pay-types/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.pay-type.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <table class="r_table table table-hover table-listing">
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td data-label="{{ trans('admin.pay-type.columns.enabled') }}">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/pay-types/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.pay-type.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
