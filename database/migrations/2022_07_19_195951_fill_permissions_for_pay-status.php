...
class FillPermissionsForPayStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPayStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pay-status',
            'admin.pay-status.index',
            'admin.pay-status.create',
            'admin.pay-status.show',
            'admin.pay-status.edit',
            'admin.pay-status.delete',
            'admin.pay-status.bulk-delete',
        ]);
