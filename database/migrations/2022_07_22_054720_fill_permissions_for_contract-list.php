...
class FillPermissionsForContractList extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContractList constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contract-list',
            'admin.contract-list.index',
            'admin.contract-list.create',
            'admin.contract-list.show',
            'admin.contract-list.edit',
            'admin.contract-list.delete',
            'admin.contract-list.bulk-delete',
        ]);
