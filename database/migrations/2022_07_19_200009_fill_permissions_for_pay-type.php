...
class FillPermissionsForPayType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPayType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pay-type',
            'admin.pay-type.index',
            'admin.pay-type.create',
            'admin.pay-type.show',
            'admin.pay-type.edit',
            'admin.pay-type.delete',
            'admin.pay-type.bulk-delete',
        ]);
