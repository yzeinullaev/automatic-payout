...
class FillPermissionsForContractListMonth extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContractListMonth constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contract-list-month',
            'admin.contract-list-month.index',
            'admin.contract-list-month.create',
            'admin.contract-list-month.show',
            'admin.contract-list-month.edit',
            'admin.contract-list-month.delete',
            'admin.contract-list-month.bulk-delete',
        ]);
